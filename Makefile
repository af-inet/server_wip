...
CFLAGS  = -Wpedantic -Wno-gnu -Wextra -Wunused -Wall -I. -Wno-initializer-overrides -Wno-missing-field-initializers -Wno-unused-parameter -Wno-missing-braces -D COMMIT_HASH=$(COMMIT)
